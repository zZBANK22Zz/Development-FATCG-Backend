...
const FtaModel = {
    ...
    saveFta: async (userId, ftaData, faultPatternType, systemName, testCaseName, xmlData = null) => {
        ...
        if (existingFta.rows.length > 0) {
            ...
            const updateFta = await pool.query(
                `UPDATE fta_testcase 
                 ...
                 WHERE user_id = $5 AND test_case_name = $6 
                 RETURNING *`,
                [faultPatternType, systemName, ftaData, xmlData, userId, testCaseName]
            );
            ...
            const newFta = await pool.query(
                `INSERT INTO fta_testcase 
                 (user_id, fault_pattern_type, system_name, test_case_name, test_case_data, xml_data, created_at, updated_at) 
                 VALUES ($1, $2, $3, $4, $5, $6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP) 
                 RETURNING *`,
                [userId, faultPatternType, systemName, testCaseName, ftaData, xmlData]
            );
